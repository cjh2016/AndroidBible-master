...
public class CharsetUtil {
     ...
     * @return 转换完成字符串
     */
    public final static String toGBKWithISO_8859_1(String input) throws UnsupportedEncodingException {
     ...
     * @return 转换完成字符串
     */
    public final static String toISO_8859_1WithGBK(String input) throws UnsupportedEncodingException {
    	if (TextUtils.isEmpty(input)) {
            return "";
        } else {
            String s1;
