...
public class GenericsUtils {
	...
	/**
	 * 通过反射,获得指定类的父类的泛型参数的实际类型. 如BuyerServiceBean extends DaoSupport<Buyer, Contact>就返回Buyer和Contact类型  
	...
	/** 
     * 通过反射,获得指定类的父类的第一个泛型参数的实际类型. 如BuyerServiceBean extends DaoSupport<Buyer, Contact>就返回Buyer和Contact类型  
