...
public class StorageManagerStub {
	...
	private static final String TAG = StorageManagerStub.class.getName();
    ...
    private static Method METHOD_StorageVolume_getUserLabel;
            ...
            if (Build.VERSION.SDK_INT < /*Build.VERSION_CODES.N*/24) {
                ...
                if (clazz != null) {
                    for (Method method : clazz.getDeclaredMethods()) {
                        ...
                        } else if ("getUserLabel".equals(methodName)) {
                        	METHOD_StorageVolume_getUserLabel = method;
                        }
                    }
                }
            }
    ...
    public static class MountService {
        ...
        public static String getStorageVolumeUserLable(Object obj) {
        	String result = null;
        	if (METHOD_StorageVolume_getUserLabel != null) {
        		result = (String) invoke("StorageVolume.getUserLabel()", 
        				METHOD_StorageVolume_getUserLabel, obj);
        	}
        	return result;
        }
        
        public static List<MountVolume> getRealMountedVolumes(Object mountService, Context context) {
        	return getMountsList(getVolumeListOldApi(mountService, context));
        }
        ...
        /**
         * 根据/proc/mounts在进一步对比确认最终的挂载路径名字
         * Method used for debugging only: read /proc/mounts
         */
        private static List<MountVolume> getMountsList(List<MountVolume> mountVolumes) {
            String filePath = "/proc/mounts";
            LineNumberReader lnr = null;
            String line;
            Log.d(TAG, "---------------------------------------------------------");
                            	...
                            	if (options.contains("rw")) {
                                    ...
                                    if (!mountPath.isHidden()) {
                                    	for (MountVolume mountVolume : mountVolumes) {
                                        	if (contained(mountVolume.getPath(), mountPoint)) {
                                        		mountVolume.setPathFile(new File(mountPoint));
                                        		break;
                                        	}
                                        } 
                                    }
        ...
        private static List<MountVolume> prepareMountVolumes(Object mountService, Object[] arr, Context context) {
            ...
            if (len > 0) {
                ...
                for (Object obj : arr) {
                    ...
                    if (volume != null && Environment.MEDIA_MOUNTED.equals(volume.getState())) {
                        volumes.add(volume);
                    }
                }
            } else {
        ...
        private static MountVolume prepareMountVolume(Object mountService, Object obj, Context context) {
            ...
            if ("android.os.storage.StorageVolume".equals(obj.getClass().getName())) {
                try {
                    ...
                    if (METHOD_StorageVolume_getUserLabel != null) {
                    	volume.setUserLabel(getStorageVolumeUserLable(obj));
                    }
