		...
		if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
			...
			try {
				...
				if (usageStatsManager != null) {
					...
					long beginTime = endTime - 86400000 * 7; //当前时间减去7天
					usageStatsList = usageStatsManager.queryUsageStats(UsageStatsManager.INTERVAL_BEST, beginTime, endTime); //查询过去7天的使用统计
				}
