...
public class NormalFragment1 extends Fragment {
    ...
    private static final String TAG = NormalFragment1.class.getSimpleName();

    public static NormalFragment1 newInstance() {
        NormalFragment1 normalFragment = new NormalFragment1();
